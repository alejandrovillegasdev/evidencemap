  ...
  $.getJSON('./src/data/csvData.json', function (csvData) {
    $.getJSON('./src/data/filters.json', function (filters) {
      $.getJSON('./src/data/referenceData.json', function (referenceData) {
        ...
        const segmentAttributes = [{ "attribute": { "AttributeSetId": 5414315, "AttributeId": 5413915, "AttributeSetDescription": "", "AttributeType": "Selectable (show checkbox)", "AttributeName": "Revisión sistemática de alta calidad", "AttributeDescription": "" }, "color": "#066738" }, { "attribute": { "AttributeSetId": 5414325, "AttributeId": 5413925, "AttributeSetDescription": "", "AttributeType": "Selectable (show checkbox)", "AttributeName": "Revisión sistemática de moderada calidad", "AttributeDescription": "" }, "color": "#fab852" }, { "attribute": { "AttributeSetId": 5414335, "AttributeId": 5413935, "AttributeSetDescription": "", "AttributeType": "Selectable (show checkbox)", "AttributeName": "Revisión sistemática de baja calidad", "AttributeDescription": "" }, "color": "#ffa500" }, { "attribute": { "AttributeSetId": 5414336, "AttributeId": 5413936, "AttributeSetDescription": "", "AttributeType": "Selectable (show checkbox)", "AttributeName": "Revisión sistemática calidad críticamente baja", "AttributeDescription": "" }, "color": "#ff0000" }];
              ...
              if (rowIdList.length > 0 && colIdList.length > 0) {
                for (const rowId of rowIdList) {
                  for (const colId of colIdList) {
                    const codeTest = reference.Codes.filter((code) => code.AttributeId === rowId || code.AttributeId === colId)
